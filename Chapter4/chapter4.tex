...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{stm32pow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{esp32pow.png}
    \caption{Mức tiêu thụ năng lượng của ESP32 Gateway}
    \label{fig:esp32pow}
\end{figure}

Cuối cùng, hình \ref{fig:totalpow} trình bày công suất tiêu thụ tổng của toàn hệ thống. Kết quả ghi nhận mức tiêu thụ trung bình là 779.43 mW.
\begin{figure}[H]
    \centering
...
\textit{Nhận xét 10: Kiến trúc đề xuất triển khai phù hợp với các thiết bị IoT hiện nay.}
\begin{itemize}
